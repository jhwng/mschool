   ...
   onClick='document.form2.action="adhoc_payments.php?action=2"; return true;'
   onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'" value="Update Ad-hoc Payments"/>
