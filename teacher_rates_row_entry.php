...
?>
	  ...
	  type="text" id="ext_rate<?php echo $j; ?>" size="8" maxlength="8" onChange='this.style.backgroundColor="#FC9494"; if (!(isPositiveNumber(this.value))) { alert("Please enter a number"); this.value = "<?php echo "$external_rate"; ?>"}; if ( document.form2.cost_type<?php echo $j; ?>.value == "F" && parseFloat(document.form2.ext_rate<?php echo $j; ?>.value) <= parseFloat(document.form2.cost<?php echo $j; ?>.value) ) { alert ("For Fixed Internal Cost, it must be less than External Rate")}' />
	  ...
	  type="text" id="cost<?php echo $j; ?>" size="8" maxlength="8" onChange='this.style.backgroundColor="#FC9494"; if (!(isPositiveNumber(this.value))) { alert("Please enter a number"); this.value = "<?php echo "$internal_cost"; ?>"};  if ( document.form2.cost_type<?php echo $j; ?>.value == "F" && parseFloat(document.form2.ext_rate<?php echo $j; ?>.value) <= parseFloat(this.value) ) { alert ("For fixed Internal Cost, it must be less than External Rate")}' />
            </div></td>
          <td height="20">
	        <div align="center">
